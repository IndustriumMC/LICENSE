...
**Legal Owner:** [Altitude Interactive](https://github.com/Altitude-Interactive/)  
...
|---|---|---|
| **Private** | [Proprietary – All Rights Reserved](./LICENSE-PRIVATE) | Altitude Interactive and explicitly authorised personnel only |
| **Public** | [MIT License](./LICENSE-PUBLIC) | Anyone, subject to attribution |
...
See [CONTRIBUTING.md](./CONTRIBUTING.md) for the rules that govern contributions to any Industrium repository.
